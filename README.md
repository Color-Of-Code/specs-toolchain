...
Tooling for the [specs framework](https://github.com/Color-Of-Code/specs-framework): lint, scaffolding, change-request lifecycle, traceability links, canonical graph import and validation, and baseline updates for any host project that uses the framework.
