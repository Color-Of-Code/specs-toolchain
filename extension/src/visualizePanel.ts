...
export function registerVisualizePanel(context: vscode.ExtensionContext): void {
    context.subscriptions.push(
        vscode.commands.registerCommand("specs.visualize.preview", () =>
            openOrRefresh(context)
        ),
        vscode.commands.registerCommand("specs.visualize.refresh", () =>
            refresh(context)
        )
    );
...
function renderHtml(
    ...
    const mermaidUri = webview.asWebviewUri(
        vscode.Uri.joinPath(mediaRoot, "mermaid.min.js")
    );
